...
{
    public partial class CeyizSetleri : Form
    {
        public CeyizSetleri()
        {
            InitializeComponent();
        ...
        private void CeyizSetleri_Load(object sender, EventArgs e)
        {
